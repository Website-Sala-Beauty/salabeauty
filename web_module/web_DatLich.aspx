<%@ Page Title="" Language="C#" MasterPageFile="~/AppMasterPage.master" AutoEventWireup="true" CodeFile="web_DatLich.aspx.cs" Inherits="web_module_web_DatLich" %>
            ...
            <div class="table1">
                <div class="block-menu2">
                    ...
                    <span>
                        ...
                        <%-- <input class="tbdb" type="datetime" id="txtNgay" runat="server" />--%>
                        <%--<label for="birthday">Birthday:</label>--%>
                        <asp:TextBox ID="txtNgay" runat="server" type="date"></asp:TextBox>
                    </span>
                </div>
                <div class="block-menu2">
                    <span>Thời gian</span>
                    <span>
                        <%--<input id="txtThoiGian" runat="server" class="tbdb" type="date" />--%>
                       <%-- <input type="date" id="txtThoiGian" class="tbdb" runat="server">--%>
                        <asp:TextBox ID="txtThoiGian" runat="server" type="time"></asp:TextBox>

                    </span>
                </div>
                <div class="block-menu2">
                    <span>Số lượng khách hàng</span>
                    <input type="text" id="txtSoLuongKhachHang" runat="server" name="name" value="1" />
                </div>
            </div>
            <hr />
        </div>
                            ...
                            <div class="block-menuchinh">
                                ...
                                <div id="modal<%#Eval("hoadonchitiet_id") %>" class="w3-modal" onclick="this.style.display='none'">
                                    <div class="w3-modal-content w3-animate-zoom">
                                        <img src="../../<%#Eval("hoadonchitiet_hinhanhchuyenkhoan") %>" />
                                    </div>
                                </div>
                            </div>
                        </ItemTemplate>
