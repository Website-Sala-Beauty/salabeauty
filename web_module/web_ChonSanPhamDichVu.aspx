<%@ Page Title="" Language="C#" MasterPageFile="~/AppMasterPage.master" AutoEventWireup="true" CodeFile="web_ChonSanPhamDichVu.aspx.cs" Inherits="web_module_web_ChonSanPhamDichVu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <link href="../css/css_ChonSanPham.css" rel="stylesheet" />
        ...
        <div class="base">
            ...
            <%--<asp:Button Class="btn-themgiohang" ID="btnDatLich" Text="Đặt Lịch" runat="server" OnClick="btnDatLich_Click2" />--%>
            <%--tab mgg--%>
        </div>
