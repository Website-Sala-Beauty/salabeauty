                      ...
                      // where n.loaisanpham_id == 41
                       ...
                       select new
                       {
                           ...
                           giohang = (from gh in db.tb_HoaDons
                                      ...
                                      where gh.khachhang_id == Convert.ToInt32(getKH.user_Id)
    ...
    protected void btnGiohang_ServerClick(object sender, EventArgs e)
    {
        ...
        if (checkTaoLichTam.Count() > 0)
        {
            ...
            var checkSanPhamTam = from sp in db.tb_HoaDonChiTiets
                                  ...
                                  where sp.sanpham_id == Convert.ToInt32(txtIDNailbox.Value) && hdt.hoadon_hidden == "Tạo giỏ hàng" && hdt.khachhang_id == getIDKhachHang.FirstOrDefault().user_Id
                                  select sp;
        ...
        else
        {
            ...
            insert.hoadon_tenkhachhang = getIDKhachHang.FirstOrDefault().user_FullName;
            insert.hoadon_createdate = DateTime.Now;
            insert.hoadon_tongtien = "0";
            insert.hoadon_hidden = "Tạo giỏ hàng";
            insert.hoadon_loaithanhtoan = "Giỏ hàng";
